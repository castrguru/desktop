                ...
                <figure class="mt-10 border-l border-indigo-600 pl-9">
                    <blockquote class="font-semibold text-gray-900">
                        <p>
                            ...
                            Lectus nibh ullamcorper ac dictum justo in euismod.
                            Risus aenean ut elit massa. In amet aliquet eget cras.
                    ...
                    <figcaption class="mt-6 flex gap-x-4">
                        <img
                            ...
                            alt="Shomari portrait"
                        />

                        <div class="text-sm/6">
                            <strong class="font-semibold text-gray-900">
                                shomari.eth
                            </strong> – Farcaster Master Builder
                        </div>
                    </figcaption>
                </figure>
